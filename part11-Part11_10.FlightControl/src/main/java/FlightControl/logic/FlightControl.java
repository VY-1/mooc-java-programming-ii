...
In our example, the application logic is stored in the package logic. Application logic includes the functionality to add airplanes and flights, and to list them.
 */
...
public class FlightControl {
    ...
    public void addFlight(Airplane plane, String departureID, String destinationID){
        ...
        this.flights.put(destinationID.toString(), flight);
    }
